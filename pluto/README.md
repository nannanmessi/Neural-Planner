...
```
 python run_training.py \
    ...
    cache.cache_path=/home/nannan/nuplan/exp/sanity_check \
...
```
 ...
 python run_training.py \
    ...
    cache.cache_path=/home/nannan/nuplan/exp/cache_pluto_1M \
    cache.cleanup_cache=true \
...
CUDA_VISIBLE_DEVICES=0 python run_training.py \
  ...
  scenario_builder=nuplan cache.cache_path=/home/nannan/nuplan/exp/sanity_check cache.use_cache_without_dataset=true \
...
CUDA_VISIBLE_DEVICES=0 python run_training.py \
  ...
  scenario_builder=nuplan cache.cache_path=/home/nannan/nuplan/exp/cache_pluto_1M cache.use_cache_without_dataset=true \
